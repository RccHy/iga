...
**new：**
- 孤儿节点监控迁移 (从iam服务迁移到本服务)
- 手动触发同步任务 gql接口
**bug fix**
- 岗位同步预览功能获取规则异常 bug fix @陈洋
- 空node保存逻辑处理(为添加规则的node节点跳过保存) @陈洋  
- 人员治理包含已删除数据更新异常 bug fix @刘雨

**image：**

- docker.qtgl.com.cn/product/iga:20230601

**依赖其他项目：**

- docker.qtgl.com.cn/product/console:20230601
