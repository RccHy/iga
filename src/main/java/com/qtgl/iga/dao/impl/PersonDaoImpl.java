...
public class PersonDaoImpl implements PersonDao {
                    ...
                    for (int i = 0; i < batchCount; i++) {
                        ...
                        int[] ints = jdbcSSO.batchUpdate(str, new BatchPreparedStatementSetter() {
                            ...
                            public void setValues(PreparedStatement preparedStatement, int i) throws SQLException {
                                ...
                                preparedStatement.setObject(18, subList.get(i).getId());
    ...
    @Override
    public Integer saveToSsoTest(Map<String, List<Person>> personMap, String
            tenantId, List<DynamicValue> valueUpdate, List<DynamicValue> valueInsert, List<DynamicAttr> attrList, ArrayList<Certificate> certificates, List<DynamicValue> dynamicValues) {
        // 删除租户下所有数据
    ...
    private StringBuffer dealDataAndAttr(Map<String, Object> arguments, StringBuffer
            stb, List<Object> param, String tenantId) {
